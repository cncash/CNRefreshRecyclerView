...
public class WrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final com.aspsine.irecyclerview.RefreshHeaderLayout mRefreshHeaderContainer;
    ...
    private RecyclerView.AdapterDataObserver mObserver = new RecyclerView.AdapterDataObserver() {
        ...
        public void onChanged() {
            com.aspsine.irecyclerview.WrapperAdapter.this.notifyDataSetChanged();
        }

        @Override
        public void onItemRangeChanged(int positionStart, int itemCount) {
            com.aspsine.irecyclerview.WrapperAdapter.this.notifyItemRangeChanged(positionStart + 2, itemCount);
        }

        @Override
        public void onItemRangeChanged(int positionStart, int itemCount, Object payload) {
            com.aspsine.irecyclerview.WrapperAdapter.this.notifyItemRangeChanged(positionStart + 2, itemCount, payload);
        }

        @Override
        public void onItemRangeInserted(int positionStart, int itemCount) {
            com.aspsine.irecyclerview.WrapperAdapter.this.notifyItemRangeInserted(positionStart + 2, itemCount);
        }

        @Override
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            com.aspsine.irecyclerview.WrapperAdapter.this.notifyItemRangeRemoved(positionStart + 2, itemCount);
        }
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    com.aspsine.irecyclerview.WrapperAdapter wrapperAdapter = (com.aspsine.irecyclerview.WrapperAdapter) recyclerView.getAdapter();
